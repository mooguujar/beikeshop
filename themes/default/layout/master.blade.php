...
<head>
  ...
  <title>@yield('title', system_setting('base.meta_title', 'BeikeShop开源好用的跨境电商系统 - BeikeShop官网') . ' Powered By cf')</title>
  ...
  <!-- <meta name="generator" content="1162212711 qq v{{ config('beike.version') }}({{ config('beike.build') }})"> -->
